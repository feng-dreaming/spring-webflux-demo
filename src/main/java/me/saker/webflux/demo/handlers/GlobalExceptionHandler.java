...
import me.saker.webflux.demo.exceptions.CustomValidationException;
import me.saker.webflux.demo.exceptions.UserDataException;
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        if (ex instanceof UserDataException) {
            return ServerResponse.badRequest()
                    ...
                    .flatMap(resp -> resp.writeTo(exchange, new HandlerStrategiesResponseContext(HandlerStrategies.withDefaults())));
